...
export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'TrungHieuDev MERN Stack Board',
    ...
    columns: [
      ...
      },
      {
        ...
        /**
         * Phía FE sẽ tự tạo ra một cái card đặc biệt: Placeholder Card, không liên quan đến BE
         * Card đặc biệt này sẽ được ẩn ở UI người dùng
         * Cấu trúc Id của cái Card này đề Unique rất đơn giản, ko phải làm radom phức tạp
         * Quan trọng khi tạo: phải đầy đủ: (_id, boardId, columnId, FE_placeholderCard)s
         */
